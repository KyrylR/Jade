...
mod tests {
    ...
    fn sign_psbt_signs_p2wpkh_wallet_inputs() {
        for fixture in [
            include_str!("../../../test_data/psbt_ss_p2wpkh.json"),
            include_str!("../../../test_data/psbt_ss_p2wpkh_spend_coinbase.json"),
        ] {
            let mut emulator = Emulator::new();
            emulator
                .platform_mut()
    ...
    fn sign_psbt_signs_green_multisig_wallet_inputs() {
        for fixture in [
            ...
            include_str!("../../../test_data/psbt_tm_multisig_p2sh_segwit.json"),
            include_str!("../../../test_data/psbt_tm_multisig_partial_p2sh_segwit.json"),
            include_str!("../../../test_data/psbt_tm_multisig_partial_segwit.json"),
            include_str!("../../../test_data/psbt_tm_multisig_segwit.json"),
            include_str!("../../../test_data/psbt_tm_p2sh_segwit.json"),
            include_str!("../../../test_data/psbt_tm_segwit.json"),
        ] {
            let mut emulator = Emulator::new();
            emulator
                .platform_mut()
